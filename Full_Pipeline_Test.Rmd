...
```
```{r}
my_autocomplete_list <- TTR::stockSymbols(exchange = c("AMEX", "NASDAQ", "NYSE", "ARCA", "BATS", "IEX"))[,c('Name', 'Symbol')]
my_autocomplete_list = setNames(my_autocomplete_list, c("label", "value"))
my_autocomplete_list
```
